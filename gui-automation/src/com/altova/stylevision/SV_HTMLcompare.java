...
public class SV_HTMLcompare extends AbstractIExplorerTest {
	private static final XMLFileReader myxml = new XMLFileReader("data\\stylevision\\sv_htmlcompare_catalog.xml");
...
/*
	...
	*/
	...
	// new testdirectory S:\QA\Internal\Regressiontest\Stylevision\CLI\
	
	@Test
	public void test_CLI_TC1() {
	int i=299;
	  String testfile=xbasefile[i]+xInputfile[i];
	  logger.fine("TCASE:" +xdescription[i]);
	  robot.openFile(testfile);robot.delay(5000);
