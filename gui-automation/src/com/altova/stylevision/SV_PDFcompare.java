...
public class SV_PDFcompare extends AbstractAcrobatReaderTest {
	private static final XMLFileReader myxml = new XMLFileReader("data\\stylevision\\sv_pdfcompare_catalog.xml");
	...
	public void CleanUp() {
		...
		//	robot.escapeDialog("date", KeyEvent.VK_ESCAPE);
			...
			logger.fine("Could not close window - probably already closed: "+e);
		}
	}
/*
	@Test
