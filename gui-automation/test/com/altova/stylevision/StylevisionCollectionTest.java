...
public class StylevisionCollectionTest extends AbstractJUnitTest {
	
	protected static StyleVisionRobot robot;
	private static final XMLFileReader myxml = new XMLFileReader("test\\com\\altova\\stylevision\\testsuite2.xml");
	...
	public void tearDown() throws Exception {
		...
		try {
			//robot.closeAll();    
			robot.close();    // workaround for TTP 23625
