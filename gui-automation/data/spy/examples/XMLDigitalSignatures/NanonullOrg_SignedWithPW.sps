...
<structure version="14" html-doctype="HTML4 Transitional" compatibility-view="IE9" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" useimportschema="1" embed-images="1" pastemode="xml" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="NanonullOrg.xsd" workingxmlfile="NanonullOrg_SignedWithPW.xml">
				<xmlsignature enable-xmlsignature="1">
					<xmlsignature-settings KeyType="Password" SignatureType="Detached" ExtensionType="Replace"/>
				</xmlsignature>
			</xsdschemasource>
		</schemasources>
	</schemasources>
