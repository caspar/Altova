...
if ( nWidth &gt; 300 )
{
	AuthenticView.EventContext.SetVariableValue( &apos;MapWidth&apos;, nWidth - 100 );
				...
				<Macro name="HidePXFIntro">
					<Source>AuthenticView.EventContext.SetVariableValue( &apos;PXFIntro&apos;, &apos;0&apos; );
AuthenticView.Event.cancelBubble = true;</Source>
				</Macro>
				<Macro name="ShowPXFIntro">
					<Source>AuthenticView.EventContext.SetVariableValue( &apos;PXFIntro&apos;, &apos;1&apos; );
AuthenticView.Event.cancelBubble = true;</Source>
				</Macro>
			</Macros>
		</Project>
			...
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<template subtype="source" match="XML">
																...
																<children>
																	<chart>
																		...
																		<layer>
																			...
																			<chartsettings>
																				<General SettingsVersion="2" ChartKind="Pie3d" Title="Overall workforce split" ShowLegend="0"/>
						...
						<variables>
							<variable name="PXFIntro" value="true()" valuetype="xs:boolean" editable="1"/>
						</variables>
					</template>
				</children>
			</globaltemplate>
