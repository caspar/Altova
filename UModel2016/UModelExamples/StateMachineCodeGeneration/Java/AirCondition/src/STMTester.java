...
public class STMTester extends javax.swing.JFrame {
  	private MySTM m_STM = new MySTM();
         ...
         */
	protected class MySTM extends AirCondition.AirConditionController
        {
	...
	public STMTester() {
        ...
        private void UpdateCurrentStateTree(AirCondition.AirConditionController.IState state, DefaultMutableTreeNode node )
        {
            for( AirCondition.AirConditionController.IRegion r : state.getRegions())
            {
